...
class RallyAchievements():
    def __init__(self, car, main_menu, sand_track, grass_track, snow_track, plains_track, savannah_track):
        self.car = car
        ...
        create_achievement("Get under 25s on Plains Track!", self.twentyfive_seconds_plains_track, icon = "confetti.png", ringtone = None)
        ...
        create_achievement("Unlock Plains Track!", self.unlock_plains_track, icon = "confetti.png", ringtone = None)
                ...
                if self.car.enabled and self.car.last_count != 0:
                    if self.snow_track.enabled and self.snow_track.unlocked:
                        if self.car.last_count <= 33:
                            ...
                            self.plains_track.unlocked = True
    ...
    def unlock_savannah_track(self):
        for menu in self.main_menu.menus:
            if menu.enabled == False:
                if self.car.enabled and self.car.last_count != 0:
                    if self.plains_track.enabled and self.plains_track.unlocked:
    ...
    def twentyfive_seconds_plains_track(self):
        if self.plains_track.enabled:
            if self.car.enabled:
                for menu in self.main_menu.menus:
                    if menu.enabled == False:
    ...
    def beat_mandaw_in_plains_track(self):
        if self.plains_track.enabled:
            for menu in self.main_menu.menus:
                if menu.enabled == False:
                    if self.car.last_count != 0:
                        if self.car.last_count <= 24.33:
                            self.car.beat_mandaw_plains_track = True
                            self.car.save_unlocked()
    ...
    def beat_mandaw_in_everything(self):
        if self.car.beat_mandaw_sand_track and self.car.beat_mandaw_grass_track \
            and self.car.beat_mandaw_snow_track and self.car.beat_mandaw_plains_track \
        ...
        return(self.car.beat_mandaw_sand_track and self.car.beat_mandaw_grass_track and \
            self.car.beat_mandaw_snow_track and self.car.beat_mandaw_plains_track and self.car.beat_mandaw_savannah_track)